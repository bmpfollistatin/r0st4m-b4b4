...
export default {
  ...
  // Button
  buttonFontFamily: 'ssb_Regular',
  // buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'ssb_Regular',
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#00492F' : '#00492F',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#B50000',
  brandWarning: '#FFB800',
  ...
  // fontFamily: platform === PLATFORM.IOS ? 'System' : 'ssb_Regular',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // titleFontfamily: platform === PLATFORM.IOS ? 'System' : 'ssb_Bold',
